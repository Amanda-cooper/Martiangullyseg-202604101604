...
class StarNet_s050Wrapper(nn.Module):
    """StarNet_s050包装类，用于UNet集成"""
    ...
    def forward(self, x):
        ...
        # StarNet_s050输出: [input_size, input_size/2, input_size/8, input_size/16, input_size/32]
...
def starnet_s050(pretrained=False, **kwargs):
    model = StarNet(16, [1, 1, 3, 1], 3, **kwargs)
    return StarNet_s050Wrapper(model)
