...
class RepViT_m0_9Wrapper(nn.Module):
    """RepViT_m0_9包装类，用于UNet集成"""
    ...
    def forward(self, x):
        ...
        # RepViT_m0_9输出: [input_size/4, input_size/8, input_size/16, input_size/32]
...
def repvit_m0_9(weights=''):
    ...
    return RepViT_m0_9Wrapper(model)
